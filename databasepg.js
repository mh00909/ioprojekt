...
readline.question('Enter the operation (delete/update): ', async (operation) => {
    if (operation === 'delete') {
        ...
        readline.question('Enter the event ID to update date: ', async (eventId) => {
            readline.question('Enter the new date (YYYY-MM-DD): ', async (newDate) => {
